...
class InputParser:
    def get_video_hoof_feature_vector(file_path):
        ...
        label_no = 0
        labels_list = []
        video_hoof = histogram.process_video(file_path)
        ...
        return input_database, labels_list
...
if __name__ == '__main__':
    ...
    input_database, labels = InputParser.get_video_hoof_feature_vector(video_file_path)
